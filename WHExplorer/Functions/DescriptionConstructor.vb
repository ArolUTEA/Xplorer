Module DescriptionConstructor
    Public Function fDescriptionConstructor(field0 As String, field1 As String, field2 As String, field3 As String, field4 As String, field5 As String, field6 As String, field7 As String)
        frmInsertNew.txtDescription.Text = field0 & " " & field1 & field2 & field3 & field4 & field5 & field6 & field7
    End Function
    Public Function fDescriptionConstructorV2(field() As String)
